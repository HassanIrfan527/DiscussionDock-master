            ...
            if (isset($catId)) {
                ...
                if ($resultThread != NULL) {
                    ...
                    <div class="d-flex gap-2 w-100 justify-content-between">
                        <div>
                            <h6 class="mb-0"><a href="/forum/threads.php?category_id=' . $result['thread_cat_id'] . '&thread_id=' . $result['thread_id'] . '">' . $result['thread_title'] . '</a></h6>
                            <p class="mb-0 opacity-75">' . $result['thread_desc'] . '</p>
                        </div>
